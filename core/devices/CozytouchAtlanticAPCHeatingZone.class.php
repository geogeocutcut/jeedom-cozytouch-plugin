...
class CozytouchAtlanticAPCHeatingZone extends AbstractCozytouchDevice
{
	//[{order},{beforeLigne},{afterLigne}]
	const DISPLAY = [
	    CozyTouchStateName::CTSN_NAME=>[1,0,0],
	    CozyTouchStateName::CTSN_TEMP=>[3,1,0],
	    CozyTouchStateName::EQ_ZONECTRLMODE=>[4,1,1],
...
// 		CozyTouchStateName::CTSN_PASSAPCHEATINGMODE => [32, 0, 0],
...
// 	    }
	...
	// Mode manu ==> comfort sur ce modele
