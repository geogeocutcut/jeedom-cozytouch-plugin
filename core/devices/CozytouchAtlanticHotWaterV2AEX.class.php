...
class CozytouchAtlanticHotWaterV2AEX extends AbstractCozytouchDevice
{
    const cold_water = 15;
	...
	public static function BuildEqLogic($device)
    {
    	...
    	$thermostat->setTemplate('dashboard', 'cozytouch::thermhotwater');
    	$thermostat->setTemplate('mobile', 'cozytouch::thermhotwater');
