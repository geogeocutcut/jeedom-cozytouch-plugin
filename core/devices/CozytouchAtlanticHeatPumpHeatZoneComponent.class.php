...
class CozytouchAtlanticHeatPumpHeatZoneComponent extends AbstractCozytouchDevice
{
	...
	const DISPLAY = [
		CozyTouchStateName::CTSN_NAME=>[1,1,1],
		CozyTouchStateName::CTSN_THERMALCONFIGURATION=>[2,0,0],
		CozyTouchStateName::CTSN_TARGETTEMP=>[3,1,0],
		CozyTouchStateName::CTSN_PASSAPCHEATINGMODE=>[4,0,0],
		CozyTouchStateName::CTSN_PASSAPCHEATINGPROFILE=>[5,0,0],
		CozyTouchStateName::CTSN_HEATINGONOFF=>[6,1,0],
		CozyTouchStateName::CTSN_COMFORTHEATINGTARGETTEMP=>[7,0,0],
		CozyTouchStateName::CTSN_ECOHEATINGTARGETTEMP=>[8,0,0],
		CozyTouchStateName::CTSN_PASSAPCCOOLINGMODE=>[9,0,0],
		CozyTouchStateName::CTSN_PASSAPCCOOLINGPROFILE=>[10,0,0],
		CozyTouchStateName::CTSN_COOLINGONOFF=>[11,1,0],
		CozyTouchStateName::CTSN_COMFORTCOOLINGTARGETTEMP=>[12,0,0],
		CozyTouchStateName::CTSN_ECOCOOLINGTARGETTEMP=>[13,0,0],
		CozyTouchStateName::CTSN_DEROGATIONONOFF=>[14,1,0],
		CozyTouchStateName::CTSN_DEROGTARGETTEMP=>[15,0,0],
		CozyTouchStateName::CTSN_DEROGATIONREMAININGTIME=>[16,0,0],
