...
class CozyTouchDeviceToDisplay
{
	...
	const CTDTD_DEVICEMODEL = [
		...
		self::CTDTD_ATLANTICTOWELDRYERIC3,
		...
		self::CTDTD_ATLANTICPASSAPCBOILER
	];
	...
	const CTDTD_DEVICESANDSENSORS = [
		...
		self::CTDTD_TOTALFOSSILENERGYCONSUMPTION,
		self::CTDTD_DHWRELATEDFOSSILENERGYCONSUMPTION,
		self::CTDTD_HEATINGRELATEDFOSSILENERGYCONSUMPTION,
...
class CozyTouchDeviceStateName
{
	const DEVICE_STATENAME = [
		...
		CozyTouchDeviceToDisplay::CTDTD_ATLANTICHOTWATERMBL=>[
			CozyTouchStateName::CTSN_NAME,
			CozyTouchStateName::CTSN_MLBMIDDLETEMP,
			CozyTouchStateName::CTSN_MLBDHWMODE,
			CozyTouchStateName::CTSN_MLBDHWCAPACITY,
			CozyTouchStateName::CTSN_CONNECT,
			CozyTouchStateName::CTSN_TARGETTEMP,
			CozyTouchStateName::CTSN_OPEMODECAPABILITIES
		],
		...
		CozyTouchDeviceToDisplay::CTDTD_ATLANTICPASSAPCHEATINGZONE=>[
			...
			CozyTouchStateName::CTSN_DEROGTARGETTEMP,
			CozyTouchStateName::CTSN_DEROGATIONREMAININGTIME,
			CozyTouchStateName::CTSN_ACIVEHETAINGPROGRAM,
			CozyTouchStateName::CTSN_HEATINGONOFF,
			CozyTouchStateName::CTSN_DEROGATIONONOFF,
			CozyTouchStateName::CTSN_CONNECT],

		CozyTouchDeviceToDisplay::CTDTD_TOTALFOSSILENERGYCONSUMPTION=>[
			CozyTouchStateName::CTSN_FOSSILENERGYCONSUMPTION],
		CozyTouchDeviceToDisplay::CTDTD_DHWRELATEDFOSSILENERGYCONSUMPTION=>[
			CozyTouchStateName::CTSN_FOSSILENERGYCONSUMPTION],
		CozyTouchDeviceToDisplay::CTDTD_HEATINGRELATEDFOSSILENERGYCONSUMPTION=>[
			CozyTouchStateName::CTSN_FOSSILENERGYCONSUMPTION],
