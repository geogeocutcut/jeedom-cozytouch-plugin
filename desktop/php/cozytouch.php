...
<div class="row row-overflow">
        ...
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <!-- <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add">
                    <i class="fa fa-plus-circle"></i> {{Ajouter un CozyTouch}}
                </a> -->
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
        <legend>{{Mes CozyTouch}}</legend> <!-- changer pour votre type d'̩quipement -->

        <?php
			if (count($eqLogics) == 0) {
				echo "<br/><br/><br/><center><span style='color:#767676;font-size:1.2em;font-weight: bold;'>{{Vous n'avez pas encore de radiateur connect̩ CozyTouch, aller sur G̩n̩ral -> Plugin et cliquez sur synchroniser pour commencer}}</span></center>";
			} 
			else {
		?>
